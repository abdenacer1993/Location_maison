...
import { CardAnnounceComponent } from "./components/cards/card-announce/card-announce.component";
...
import { DoctorCardComponent } from "./components/announce-card/announce-card.component";
...
import { PopupModifannonceComponent } from './popup-modifannonce/popup-modifannonce.component';
import { CardSettings2Component } from './components/cards/card-settings2/card-settings2.component';
...
@NgModule({
  declarations: [
    ...
    ReviewComponent,
    AjouterAnnounceComponent,
    MesAnnouncesComponent,
    MySchedulesComponent,
    AppointmentRequestsComponent,
    RateModalComponent,
    CommentsBoxComponent,
    CommentComponent,
    PopupModifannonceComponent,
    CardSettings2Component,
  ],
  imports: [
    CommonModule,
    HttpClientModule,
